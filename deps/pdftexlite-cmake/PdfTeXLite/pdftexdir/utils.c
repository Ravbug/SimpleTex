...
void utils_init()
{
    ...
    last_ury = 0;
        ...
        ret_urx = 0;
        ret_ury = 0;
        pos_stack = 0;        /* the stack */
        pos_stack_size = 0;  /* initially empty */
        pos_stack_used = 0;  /* used entries */
        matrix_stack = 0;
        matrix_stack_size = 0;
        matrix_stack_used = 0;
        colstacks = NULL;
        ...
        colstacks_used = 0;
        page_mode = 0;
        sub_match_count = DEFAULT_SUB_MATCH_COUNT;
        pmatch = NULL;
        match_string = NULL;
        ...
        jobname_cstr = NULL;
        job_id_string = NULL;
        last_ptr_index = 0;          /* for use with alloc_array */
        fb_array = 0;
        fb_ptr = 0;
        fb_limit = 0;
        char_array = 0;
        ...
        vf_i_fnts_limit = 0;
        st_tree = NULL;
        pdftexbanner_init = false;
}

void init_pdftex_lib()
{
